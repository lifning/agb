...
impl AffineMap {
    ...
    pub fn set_center_point(&mut self, center: Vector2D<Num<i32, 8>>) {
        self.bg_center = center;
    }
    ...
    pub fn set_scale_only(
        ...
        self.set_transform_raw(BgAffineSetData {
            ...
            position: Vector2D::new(
                self.bg_center.x - scale.x.change_base() * destination.x,
                self.bg_center.y - scale.y.change_base() * destination.y,
            ),
        });
    }
